# xpr — Builders  App
xpr — Builders est un formulaire de dépouillement fondé sur des technologies XML et réalisé dans le cadre de l’ANR Experts.

Ce formulaire est une extension de l'application xpr ([https://github.com/anrExperts/xpr](https://github.com/anrExperts/xpr)) pour le traitement des dossiers de réception de maçon.
